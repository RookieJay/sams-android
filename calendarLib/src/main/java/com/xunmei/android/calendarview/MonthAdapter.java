...
import com.xunmei.android.calendarview.bean.CalendarDayModel;
import com.xunmei.android.calendarview.bean.CalendarMonthModel;
...
public class MonthAdapter extends RecyclerView.Adapter<MonthAdapter.MonthHolder>
    ...
    private CalendarView.OnSelectedDayListener onSelectedDayListener;
    ...
    public CalendarView.OnSelectedDayListener getOnSelectedDayListener() {
        return onSelectedDayListener;
    }

    public void setOnSelectedDayListener(CalendarView.OnSelectedDayListener onSelectedDayListener) {
